...
def country_code_printer():
    print("""\nHere are the European countries and their country codes as help:
Albania: AL, Andorra: AD, Armenia: AM, Austria: AT, Belarus: BY, Belgium: BE, Bosnia and Herzegovina: BA, 
